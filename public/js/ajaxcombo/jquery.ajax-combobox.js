    ...
    $.extend(AjaxComboBox.prototype, /** @lends AjaxComboBox.prototype */ {
        ...
        _setOption1st: function (source, option) {
            return $.extend({
                ...
                navi_num: 5,
                primary_key: 'id',
                button_img: '/js/ajaxcombo/btn.png',
                bind_to: false,
                navi_simple: false,
        ...
        _selectCurrentLine: function (self, is_enter_key) {
            ...
            if (current) {
                if (self.option.plugin_type != 'textarea') {
                    ...
                    // 左側空白の補完
                    if (
                        self.option.tags[self.prop.tag.type].space[0] && !left.match(self.option.tags[self.prop.tag.type].pattern.space_left)
                    ) {
                    ...
                    // 右側空白の補完
                    if (
                        self.option.tags[self.prop.tag.type].space[1] && !right.match(self.option.tags[self.prop.tag.type].pattern.space_right)
                    ) {
