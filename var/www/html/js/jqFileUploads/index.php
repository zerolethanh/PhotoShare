...
<head>
    ...
    <![endif]-->
    <meta charset="utf-8">
    <title><?= $event->event_name; ?> - PhotoShare</title>
    ...
    <!-- Generic page styles -->
    <link rel="stylesheet" href="/js/jqFileUploads/css/style.css">
    <!-- blueimp Gallery styles -->
    <link rel="stylesheet" href="//blueimp.github.io/Gallery/css/blueimp-gallery.min.css">
    <!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
    <link rel="stylesheet" href="/js/jqFileUploads/css/jquery.fileupload.css">
    <link rel="stylesheet" href="/js/jqFileUploads/css/jquery.fileupload-ui.css">
    <!-- CSS adjustments for browsers with JavaScript disabled -->
    <noscript>
        <link rel="stylesheet" href="/js/jqFileUploads/css/jquery.fileupload-noscript.css">
    </noscript>
    <noscript>
...
<div class="navbar navbar-default navbar-fixed-top">
    <div class="container bg">
        <div class="navbar-header">
            <a class="navbar-brand" href="/event/<?= $event->id ?>/photo" style="color:white;text-align: center">
                <?= $event->event_name; ?>
            </a>
        </div>
    </div>
...
<div class="container">
    ...
    <form id="fileupload" action="/photo" method="POST" enctype="multipart/form-data">
        <!-- Redirect browsers with JavaScript disabled to the origin page -->
        <noscript><input type="hidden" name="redirect" value="https://blueimp.github.io/jQuery-File-Upload/"></noscript>

        <!--        <div>-->
        <!--            <span><input type="text" id="event_name" placeholder="Album Name"/></span>-->
        <!--            <span><input type="date" id="or_time" placeholder="Date"/></span>-->
        <!--        </div>-->
        <!--        <br>-->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-1">
                        <button type="button" class="btn btn-sm btn-default"
                                onclick="location.href='/event/<?= $event->id ?>/photo'">
